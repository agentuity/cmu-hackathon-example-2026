...
import type agent from '../agent/hackathon-scout/index.js';
...
/**
 * Input type for route: POST /api/search
 */
export type POSTApiSearchInput = InferInput<typeof agent['inputSchema']>;

/**
 * Output type for route: POST /api/search
 */
export type POSTApiSearchOutput = InferOutput<typeof agent['outputSchema']>;

/**
 * Input schema type for route: POST /api/search
 */
export type POSTApiSearchInputSchema = typeof agent extends { inputSchema?: infer I } ? I : never;

/**
 * Output schema type for route: POST /api/search
 */
export type POSTApiSearchOutputSchema = typeof agent extends { outputSchema?: infer O } ? O : never;
...
declare module '@agentuity/frontend' {
	...
	'POST /api/search': {
				inputSchema: POSTApiSearchInputSchema;
				outputSchema: POSTApiSearchOutputSchema;
	...
	export interface RPCRouteRegistry {
		...
		search: {
			 ...
			 */
			stream: { input: POSTApiSearchInput; output: POSTApiSearchOutput; type: 'stream'; params: never; paramsTuple: [] };
		};
	}
}
